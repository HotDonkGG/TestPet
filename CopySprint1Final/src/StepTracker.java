...
public class StepTracker {
    ...
    public final Map<Integer, String> monthes = new HashMap<>() {
        {
    ...
    public void printBestSeries(int monthNumber) {
        Map<Integer, Integer> integerIntegerMap = getData().get(monthNumber);
        Integer best = 0;
        Integer serie = 0;
        for (Map.Entry<Integer, Integer> entry : integerIntegerMap.entrySet()) {
        ...
        System.out.println("максимальное количество подряд идущих дней " + best);
    }
}